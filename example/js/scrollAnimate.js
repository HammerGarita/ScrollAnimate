...
(function (root, factory) {
  ...
  ScrollAnimate.add = function (parametersObject) {
    ...
    /*
     * ----------------------------------------------------------------
     * Valida el tipo de dispositivo y el tamaño de pantalla. Si coincide detiene la ejecución
     *----------------------------------------------------------------
     */
    ...
    window.addEventListener('scroll', function () {
      Array.from(_elementObject).forEach(function (_selectedItem) {
        ...
        _elementPosition = _selectedItem.getBoundingClientRect(); // Calcula la posición del elemento en relacion al offset
